...
# # Checks for how many times an element appears in a tuple

# #find the index of an element in a tuple
# print(tuple1.index(3)) # Output: 2 (What is the index of 3, not where is the 3rd letter)
...
print(text_tuple) # Every letter is separated by a comma
...
# Output the result
print(f"Total number of 'v' characters: {total_v}") # Output: 53
...
sample_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]] # Yellow thing tells me that this is one big list. The three little lists count as individual elements in the big list. If I wanted to access something in the mini-lists ...
# get length of the list
print(len(sample_list)) # Output: 3
print(sample_list[2][2]) # Output: 9 (Counts from 0, 1, 2, 3 and so forth)
print(sample_list[1][2]) # Output: 6, also works with -1
print(sample_list[1][0]) # Output: 4
print(sample_list[0][2]) # Output: 3
print(sample_list[0]) # Prints all 3 numbers in the first small list. Output: [1, 2, 3]
print(sample_list[2][1]) # Output: 8
#this is called a nested list
# Extract and print the second element from the first list


sample_list_of_fruit = {"fruits": ["apple", "banana", "cherry"]} # List is nested inside of the dictionary 'fruits.'
...
print(sample_list_of_lists["lists"][2][-1]) # Output: 9
